                        ...
                        try:
                            agentes = [
                                ...
                                Agent(
                                    ...
                                    goal=f"Realizar a segmentação de mercado para {nome_cliente}, com base nas análises PEST, SWOT e BCG.",
                                    backstory="Você é um analista de segmentação de mercado experiente e ajudará a identificar os melhores segmentos de mercado para {nome_cliente}.",
                                    allow_delegation=False,
                                    llm=modelo_linguagem,
                                    tools=[PDFSearchTool(), CSVSearchTool()]
                                )
