...
# CRM
    ...
    intuito_plano = st.text_input('Intuito do Plano Estratégico:', help="Defina o que se espera alcançar com este plano de Inbound Marketing. O objetivo principal pode incluir aumentar a base de clientes ou melhorar o relacionamento com clientes atuais.")
