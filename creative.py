            ...
            with st.spinner('Gerando criativos de posts...'):
                ...
                agentes = [
                    Agent(
                        ...
                        backstory="Você é um especialista em marketing digital, especializado em criar títulos de post criativos para campanhas no Google ou Meta.",
                    ...
                    Agent(
                        ...
                        backstory="Você é um especialista em criar descrições criativas para posts de campanhas no Google ou Meta.",
                        allow_delegation=False,
                        llm=modelo_linguagem
                    ),
                    Agent(
                        ...
                        backstory="Você é um especialista em marketing digital, criando textos otimizados para links em campanhas de Google ou Meta.",
                        allow_delegation=False,
                        llm=modelo_linguagem
                    ),
                    Agent(
                        ...
                        backstory="Você é um especialista em criar extensões de frase de destaque para campanhas publicitárias no Google ou Meta.",
                        allow_delegation=False,
                        llm=modelo_linguagem
                    )
                ]
